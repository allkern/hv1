...
bool hyrisc_execute(hyrisc_t* proc, hyint_t cycle) {
    switch (proc->internal.decoder.opcode) {
        ...
        case HY_ADDSI8 : { alu::perform_operation(proc, REGX, REGX, I8  , alu::HY_adds); return true; } break;
        ...
        case HY_SUBSI8 : { alu::perform_operation(proc, REGX, REGX, I8  , alu::HY_subs); return true; } break;
        ...
        case HY_MULSI8 : { alu::perform_operation(proc, REGX, REGX, I8  , alu::HY_muls); return true; } break;
        ...
        case HY_DIVSI8 : { alu::perform_operation(proc, REGX, REGX, I8  , alu::HY_divs); return true; } break;
        ...
        case HY_ANDI8  : { alu::perform_operation(proc, REGX, REGX, I8  , alu::HY_and ); return true; } break;
        ...
        case HY_ORI8   : { alu::perform_operation(proc, REGX, REGX, I8  , alu::HY_or  ); return true; } break;
        ...
        case HY_XORI8  : { alu::perform_operation(proc, REGX, REGX, I8  , alu::HY_xor ); return true; } break;
        ...
        case HY_LSLR  : { alu::perform_operation(proc, REGX, REGY, 0, alu::HY_lsl); return true; } break;
        case HY_LSLI16: { alu::perform_operation(proc, REGX, I16 , 0, alu::HY_lsl); return true; } break;
        case HY_LSRR  : { alu::perform_operation(proc, REGX, REGY, 0, alu::HY_lsr); return true; } break;
        case HY_LSRI16: { alu::perform_operation(proc, REGX, I16 , 0, alu::HY_lsr); return true; } break;
        case HY_ASLR  : { alu::perform_operation(proc, REGX, REGY, 0, alu::HY_asl); return true; } break;
        case HY_ASLI16: { alu::perform_operation(proc, REGX, I16 , 0, alu::HY_asl); return true; } break;
        case HY_ASRR  : { alu::perform_operation(proc, REGX, REGY, 0, alu::HY_asr); return true; } break;
        case HY_ASRI16: { alu::perform_operation(proc, REGX, I16 , 0, alu::HY_asr); return true; } break;
